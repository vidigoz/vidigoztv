...
function renderEmailLocal({ titulo, cuerpo, imagenUrl, unsubscribeLink, siteUrl }) {
  ...
  const imageBlock = imagenUrl ? `<tr><td style="padding:0 0 24px;"><img src="${escapeHtmlLocal(imagenUrl)}" alt="" width="100%" style="display:block;width:100%;max-width:600px;border-radius:12px;"></td></tr>` : '';
  return `<!DOCTYPE html>
  ...
  <tr><td align="center" style="padding:32px 16px;">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;">
      ...
      <tr><td style="padding:28px 10px 0;text-align:center;">
        <p style="margin:0 0 10px;font-family:'Manrope',Arial,sans-serif;font-size:12.5px;color:rgba(242,239,233,.45);">Recibes este correo porque te suscribiste en <a href="${site}" style="color:#e2632f;text-decoration:none;">${site.replace(/^https?:\/\//, '')}</a></p>
