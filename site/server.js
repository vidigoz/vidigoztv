        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr><td>
            <table role="presentation" cellpadding="0" cellspacing="0"><tr>
              <td style="padding-right:10px;"><a href="https://www.facebook.com/vidigoztv" style="display:inline-block;width:40px;height:40px;background-color:#0c0a1c;border-radius:10px;text-align:center;line-height:40px;"><img src="${FB_ICON_LOCAL}" width="18" height="18" alt="Facebook" style="vertical-align:middle;"></a></td>
              <td style="padding-right:10px;"><a href="https://www.instagram.com/vidigoztv/" style="display:inline-block;width:40px;height:40px;background-color:#0c0a1c;border-radius:10px;text-align:center;line-height:40px;"><img src="${IG_ICON_LOCAL}" width="18" height="18" alt="Instagram" style="vertical-align:middle;"></a></td>
              <td><a href="https://www.tiktok.com/@vidigoztv" style="display:inline-block;width:40px;height:40px;background-color:#0c0a1c;border-radius:10px;text-align:center;line-height:40px;"><img src="${TT_ICON_LOCAL}" width="18" height="18" alt="TikTok" style="vertical-align:middle;"></a></td>
            </tr></table>
          </td></tr>
        </table>
      </td></tr>
